...
(cl-defstruct (org-supertag-node (:constructor org-supertag-node--create)
  ...
  ;; 基础标识
  (id          nil :read-only t :type string  :documentation "节点ID")
  ...
  ;; 位置追踪
  (file-path   nil :read-only t :type string  :documentation "文件路径")
  (olp         nil :read-only t :type list    :documentation
               "Return list of ancestor headings to this node.")
  (pos         nil :read-only t :type integer :documentation "节点位置")
  ...
  ;; 核心数据
  (tags        nil :read-only t :type list    :documentation "标签列表")
  (properties  nil :read-only t :type list    :documentation "属性列表")
  
  ;; 引用关系
  (refs-to     nil :read-only t :type list    :documentation "引用的节点")
  (refs-from   nil :read-only t :type list    :documentation "被引用的节点")
  (ref-count   0   :read-only t :type integer :documentation "引用计数"))
