...
(defun ostb-test-ping-bridge ()
  ...
  (let ((response (org-supertag-bridge-call-sync "ping" 5)))
...
(defun ostb-test-echo-bridge (message-to-echo)
  ...
  (let ((response (org-supertag-bridge-call-sync "echo" 5 message-to-echo)))
...
(defun ostb-test-get-status-bridge ()
  ...
  (let ((response (org-supertag-bridge-call-sync "get_status" 10)))
