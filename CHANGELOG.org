...
- Typing =#newtag= and continuing to write (without explicitly
  selecting the popup =[new]= candidate) now records the tag
  immediately via a new =post-self-insert-hook=. corfu/company quit
...
- Added =test-completion-newtag.el= as a runnable batch self-check.
