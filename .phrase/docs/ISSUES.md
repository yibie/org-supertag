...
- issue009 [ ] 父子标签已统一为 `:extends`：可用 `happy` 搜索并显示 `diary/happy`，Schema 同树缩进；Corfu affixation 崩溃已修，待用户实机确认（.phrase/docs/issue_nested_tags_20260624.md / tech-refer_nested_tags_20260624.md）
