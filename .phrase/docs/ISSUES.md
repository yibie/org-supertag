...
- issue009 [ ] 父子标签已统一为 `:extends`：既可用 `happy` 搜索，也可从 `diary` 渐进发现 `diary/happy`；Schema 同树缩进，待用户实机确认（.phrase/docs/issue_nested_tags_20260624.md / tech-refer_nested_tags_20260624.md）
